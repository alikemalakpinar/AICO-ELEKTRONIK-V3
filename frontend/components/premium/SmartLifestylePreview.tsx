...
const screenContentData = {
  tr: {
    badge: 'AKILLI YASAM DENEYIMI',
    title: 'Tek Ekran,',
    titleHighlight: 'Sinirsiz Kontrol',
    subtitle: 'Villa, apartman veya rezidans - tum yasam alaninizi tek bir uygulamadan yonetin.',
    modes: [
      {
        id: 'villa',
        icon: Home,
        title: 'Villa Modu',
        subtitle: 'Kisisel Luks & Konfor',
        description: 'Havuz sicakligi, RGB aydinlatma, guvenlik kameralari ve daha fazlasi. Eviniz size ozel bir deneyim sunar.',
        theme: 'luxury',
        color: 'from-amber-500 to-orange-600',
        bgGradient: 'from-amber-500/10 via-transparent to-transparent',
        screenElements: [
          { icon: Thermometer, label: 'Havuz', value: '28°C', status: 'active' },
          { icon: Lightbulb, label: 'RGB Isiklar', value: 'Aksamci', status: 'active' },
          { icon: Camera, label: 'Guvenlik', value: '4 Kamera', status: 'monitoring' },
          { icon: Wind, label: 'Iklimlendirme', value: '23°C', status: 'active' },
          { icon: Lock, label: 'Alarm', value: 'Pasif', status: 'idle' },
          { icon: Droplets, label: 'Bahce Sulama', value: '06:00', status: 'scheduled' },
        ],
        quickActions: ['Isiklari Ac', 'Havuz Isit', 'Alarm Aktif'],
      },
      {
        id: 'apartment',
        icon: Building,
        title: 'Apartman Modu',
        subtitle: 'Iletisim & Topluluk',
        description: 'Video diafon, aidat takibi, duyurular ve komsu iletisimi. Apartman yasaminizi kolaylastirin.',
        theme: 'communication',
        color: 'from-indigo-500 to-purple-600',
        bgGradient: 'from-indigo-500/10 via-transparent to-transparent',
        screenElements: [
          { icon: Video, label: 'Kapi Zili', value: 'Beklemede', status: 'idle' },
          { icon: Receipt, label: 'Aidat', value: '₺850', status: 'pending' },
          { icon: Bell, label: 'Duyurular', value: '3 Yeni', status: 'notification' },
          { icon: Lock, label: 'Kapi Kilidi', value: 'Guvenli', status: 'locked' },
          { icon: Wifi, label: 'Internet', value: '100 Mbps', status: 'active' },
          { icon: Smartphone, label: 'Misafir Girisi', value: 'QR Kod', status: 'ready' },
        ],
        quickActions: ['Kapiyi Ac', 'Aidat Ode', 'Duyuru Gor'],
      },
      {
        id: 'residence',
        icon: Building2,
        title: 'Rezidans Modu',
        subtitle: 'Yonetim & Verimlilik',
        description: 'HVAC merkezi kontrol, asansor cagirma, enerji analitigi. Kurumsal yasam standartlari.',
        theme: 'management',
        color: 'from-rose-500 to-pink-600',
        bgGradient: 'from-rose-500/10 via-transparent to-transparent',
        screenElements: [
          { icon: Wind, label: 'HVAC Merkezi', value: '22°C', status: 'active' },
          { icon: Gauge, label: 'Asansor', value: 'Kat 3', status: 'moving' },
          { icon: BarChart3, label: 'Enerji', value: '-15%', status: 'saving' },
          { icon: Shield, label: 'Guvenlik', value: '24/7', status: 'monitoring' },
          { icon: Thermometer, label: 'Ortak Alan', value: '21°C', status: 'active' },
          { icon: Bell, label: 'Yonetim', value: '2 Mesaj', status: 'notification' },
        ],
        quickActions: ['Asansor Cagir', 'HVAC Ayarla', 'Rapor Al'],
      },
    ],
  },
  en: {
