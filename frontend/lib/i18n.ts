...
export const translations = {
  tr: {
    ...
    common: {
      loading: 'Yukleniyor...',
      systemLoading: 'Sistem Yukleniyor',
      error: 'Bir hata olustu',
      errorDescription: 'Beklenmedik bir hata meydana geldi. Lutfen sayfayi yenileyin veya ana sayfaya donun.',
      errorCode: 'Hata Kodu',
      tryAgain: 'Tekrar Dene',
      homePage: 'Ana Sayfa',
      supportLink: 'Sorun devam ederse bize ulasin',
      back: 'Geri',
      next: 'Ileri',
      submit: 'Gonder',
